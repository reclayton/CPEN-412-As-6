; C:\USERS\RCLAY\DESKTOP\CPEN_412\CPEN-412-AS-6\PROGRAMS\AS6-MULTITHREAD\CANBUSTEST.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
; #include <stdio.h>
; #include <stdlib.h>
; /*********************************************************************************************
...
; do{
CanBus1_Receive_1:
; }while( (Can1_StatusReg & RBS_Bit) == 0);
       move.b    5243396,D0
       and.b     #1,D0
...
@canbus~2_4:
       dc.b      112,105,110,103,10,0
@canbus~2_5:
       dc.b      116,114,97,110,115,10,0
@canbus~2_6:
       dc.b      13,10,0
@canbus~2_7:
       dc.b      112,111,110,103,10,0
@canbus~2_8:
